...
public class ShowDetailsActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        rvRelated.setLayoutManager(new LinearLayoutPagerManager(ShowDetailsActivity.this, LinearLayoutManager.HORIZONTAL, false, 2.15));
        rvRelated.setFocusable(false);
        rvRelated.setNestedScrollingEnabled(false);

        rvEpisode.setHasFixedSize(true);
        rvEpisode.setLayoutManager(new LinearLayoutPagerManager(ShowDetailsActivity.this, LinearLayoutManager.HORIZONTAL, false, 2.15));
