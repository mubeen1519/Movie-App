...
public class ActorDirectorDetailActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        rvMovie.setLayoutManager(new LinearLayoutPagerManager(ActorDirectorDetailActivity.this, LinearLayoutManager.HORIZONTAL, false, 3.3));
        rvMovie.setFocusable(false);
        rvMovie.setNestedScrollingEnabled(false);

        rvShow.setHasFixedSize(true);
        rvShow.setLayoutManager(new LinearLayoutPagerManager(ActorDirectorDetailActivity.this, LinearLayoutManager.HORIZONTAL, false, 2.15));
