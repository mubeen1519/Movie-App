...
public class SearchHorizontalActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        rvMovie.setLayoutManager(new LinearLayoutPagerManager(SearchHorizontalActivity.this, LinearLayoutManager.HORIZONTAL, false, 3.3));
        rvMovie.setFocusable(false);
        rvMovie.setNestedScrollingEnabled(false);

        rvShow.setHasFixedSize(true);
        rvShow.setLayoutManager(new LinearLayoutPagerManager(SearchHorizontalActivity.this, LinearLayoutManager.HORIZONTAL, false, 2.15));
        rvShow.setFocusable(false);
        rvShow.setNestedScrollingEnabled(false);

        rvSport.setHasFixedSize(true);
        rvSport.setLayoutManager(new LinearLayoutPagerManager(SearchHorizontalActivity.this, LinearLayoutManager.HORIZONTAL, false, 2.15));
        rvSport.setFocusable(false);
        rvSport.setNestedScrollingEnabled(false);


        rvTV.setHasFixedSize(true);
        rvTV.setLayoutManager(new LinearLayoutPagerManager(SearchHorizontalActivity.this, LinearLayoutManager.HORIZONTAL, false, 2.15));
