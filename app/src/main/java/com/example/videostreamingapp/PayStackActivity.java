...
public class PayStackActivity extends AppCompatActivity implements OnCreditCardStateChanged {
    ...
    String planId, planPrice, planCurrency, planGateway, planGateWayText, payStackPublicKey,couponCode, couponPercentage;
    Button btnPay;
            ...
            public void onSuccess(Transaction transaction) {
                ...
                if (NetworkUtils.isConnected(PayStackActivity.this)) {
                    new com.example.videostreamingapp.Transaction(PayStackActivity.this)
                            .purchasedItem(planId, transaction.getReference(), planGateway, couponCode, couponPercentage);
                } else {
