...
public class SelectPlanActivity extends AppCompatActivity {
    ...
    RadioButton radioPayPal, radioStripe, radioRazorPay, radioPayStack, radioInstaMojo, radioPayU, radioPayTM, radioCashFree, radioFlutterWave, radioCoinGate, radioMollie, radioBankTransfer;
    ...
    private void displayData() {
        ...
        if (!paymentSetting.isPayPal() && !paymentSetting.isStripe()
                ...
                && !paymentSetting.isPayTM() && !paymentSetting.isCashFree() && !paymentSetting.isFlutterWave() && !paymentSetting.isCoinGate() && !paymentSetting.isMollie() && !paymentSetting.isBankTransfer()) {
